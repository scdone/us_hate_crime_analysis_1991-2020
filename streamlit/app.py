...
csv_2001 = Path("datasets", "per_capita_2001.csv")
csv_2002 = Path("datasets", "per_capita_2002.csv")
csv_2003 = Path("datasets", "per_capita_2003.csv")
csv_2004 = Path("datasets", "per_capita_2004.csv")
csv_2005 = Path("datasets", "per_capita_2005.csv")
csv_2006 = Path("datasets", "per_capita_2006.csv")
csv_2007 = Path("datasets", "per_capita_2007.csv")
csv_2008 = Path("datasets", "per_capita_2008.csv")
csv_2009 = Path("datasets", "per_capita_2009.csv")
csv_2010 = Path("datasets", "per_capita_2010.csv")
csv_2011 = Path("datasets", "per_capita_2011.csv")
csv_2012 = Path("datasets", "per_capita_2012.csv")
csv_2013 = Path("datasets", "per_capita_2013.csv")
csv_2014 = Path("datasets", "per_capita_2014.csv")
csv_2015 = Path("datasets", "per_capita_2015.csv")
csv_2016 = Path("datasets", "per_capita_2016.csv")
csv_2017 = Path("datasets", "per_capita_2017.csv")
csv_2018 = Path("datasets", "per_capita_2018.csv")
csv_2019 = Path("datasets", "per_capita_2019.csv")
...
df_2002 = pd.read_csv(csv_2002)
df_2003 = pd.read_csv(csv_2003)
df_2004 = pd.read_csv(csv_2004)
df_2005 = pd.read_csv(csv_2005)
df_2006 = pd.read_csv(csv_2006)
df_2007 = pd.read_csv(csv_2007)
...
us_totals_csv = Path("datasets", "us_per_cap_totals.csv")
